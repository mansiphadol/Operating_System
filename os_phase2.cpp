...
//* Global variables
ifstream infile("input_phase2.txt");
ofstream outfile;
...
void OS::TERMINATE(int ERR_CODE)
{
    ...
    case 6:
        ...
        break;
    case 7:
        cout << " TIME LIMIT EXCEEDED And OPERATION CODE ERROR" << endl;
        break;
    case 8:
        cout << " TIME LIMIT EXCEEDED And OPERAND ERROR" << endl;
        break;
    }
    ...
    {
        cout << endl; // Add an extra line for formatting
    }
